def soustraire_nombre(nombre1, nombre2):
    """
    Cette fonction prend deux nombres en entrée et renvoie leur différence.
    ...
    Returns:
    float: La différence entre nombre1 et nombre2.
